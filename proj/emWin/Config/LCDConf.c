...
//	LCD_SetSizeEx    (0, LCD_GetHeight(), LCD_GetWidth());
//	LCD_SetVSizeEx   (0, LCD_GetHeight(), LCD_GetWidth());
	
	
//	GUI_TOUCH_Calibrate(GUI_COORD_Y, 0, XSIZE_PHYS - 1, g_tTP.usAdcX1, g_tTP.usAdcY1);
//    GUI_TOUCH_Calibrate(GUI_COORD_X, 0, YSIZE_PHYS - 1, g_tTP.usAdcX2, g_tTP.usAdcY2);
//	
//	if(g_tTP.XYChange == 1)
//	{
