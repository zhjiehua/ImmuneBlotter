...
/**
  ...
  * @retval none
  */
static void _cbCalibration(WM_MESSAGE * pMsg)
{
...
void WDAGUI_Calibration(void)
{
	...
	hProject->hAPP = WM_CreateWindowAsChild(
		...
		WinPara.xSizeWin, 
		WinPara.ySizeWin, 
		WinPara.hWinMain, WM_CF_SHOW | WM_CF_STAYONTOP, _cbCalibration, 0);	
	...
	/* show sorry */
	MESSAGEBOX_Create("there is no Calibration","sorry",GUI_MESSAGEBOX_CF_MODAL);
}
