...
void WDAGUI_Information(void)
{
	...
	hProject->hAPP = WM_CreateWindowAsChild(
		...
		WinPara.xSizeWin, 
		WinPara.ySizeWin, 
		WinPara.hWinMain, WM_CF_SHOW | WM_CF_STAYONTOP, _cbInformation, 0);	
	...
	/* show sorry */
	MESSAGEBOX_Create("there is no Information","sorry",GUI_MESSAGEBOX_CF_MODAL);
}
