...
/**
  ...
  * @retval none
  */
static void _cbBackflow(WM_MESSAGE * pMsg)
{
...
void WDAGUI_Backflow(void)
{
	...
	hProject->hAPP = WM_CreateWindowAsChild(
		...
		WinPara.xSizeWin, 
		WinPara.ySizeWin, 
		WinPara.hWinMain, WM_CF_SHOW | WM_CF_STAYONTOP, _cbBackflow, 0);	
	...
	/* show sorry */
	MESSAGEBOX_Create("there is no Backflow","sorry",GUI_MESSAGEBOX_CF_MODAL);
}
